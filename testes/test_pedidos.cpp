...
char* test_buscarPedidoPorId() {
    ...
    mu_assert("Erro: Pedido 1 deve estar na posicao 0", buscarPedidoPorId(1, pedidos, 2) == 0);
    mu_assert("Erro: Pedido 2 deve estar na posicao 1", buscarPedidoPorId(2, pedidos, 2) == 1);
