...
char *test_buscarVeiculoPorPlaca() {
    ...
    mu_assert("Erro: ABC1234 deve estar na posição 0", buscarVeiculoPorPlaca("ABC1234", veiculos, 2) == 0);
    mu_assert("Erro: XYZ9876 deve estar na posição 1", buscarVeiculoPorPlaca("XYZ9876", veiculos, 2) == 1);
